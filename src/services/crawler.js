...
const crawlerRun = () => {
    ...
    amqp.connect(getConnectStr(), function (err, conn) {
        conn.createChannel(function (err, ch) {
            ...
            for (var i = 1; i = CRAWLER_CONFIG.MAX_PAGE.PROJECT; i++)
